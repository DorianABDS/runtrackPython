...
label_title = Label (window, text="Bienvenue sur l'application", font=("Montserrat, 20"), bg='#2D2D2D', fg="white")
label_title.pack(expand=YES)

# ajouter un second texte
label_subtitle = Label (window, text="Hello world", font=("Montserrat, 15"), bg='#2D2D2D', fg="white")
