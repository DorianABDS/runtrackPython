...
var1 = IntVar()
var2 = IntVar()
c1 = Checkbutton(right_frame, text='Python',variable=var1, onvalue=1, offvalue=0, command=print_selection)
c1.pack()
c2 = Checkbutton(right_frame, text='C++',variable=var2, onvalue=1, offvalue=0, command=print_selection)
c2.pack()
