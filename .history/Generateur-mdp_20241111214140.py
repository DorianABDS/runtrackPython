...
label_title = Label (right_frame, text="Le nouveau mot de passe sera généré entre 8 et 12 caractères. Ni plus, ni moins ! ", font=("Montserrat, 20"), bg='#2D2D2D', fg="white")
label_title.pack()
