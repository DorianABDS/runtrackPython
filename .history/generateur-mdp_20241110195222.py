...
class Window (TK):
    def __init__(self):
        ...
        entry2 = customtkinter.CTkEntry (self.frame, width=120,height=25, corner_radius=10) entry2.place(relx=0.7, rely=0.3, anchor=CENTER)
        ...
        entry3 = customtkinter.CTkEntry(self.frame, width=120,height=25, corner_radius=10) entry3.place(relx=0.7, rely=0.5, anchor=CENTER)
