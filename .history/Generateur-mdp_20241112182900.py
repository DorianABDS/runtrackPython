...
# créer des checkbox
choice = IntVar()
c1 = Checkbutton(right_frame, text="Chiffre", variable=choice, value=1, command=selection)
c1.pack()
c2 = Checkbutton(right_frame, text="Spéciaux", variable=choice, value=2, command=selection)
c2.pack()
c3 = Checkbutton(right_frame, text="Hard", variable=choice, value=3, command=selection)
c3.pack()
...
passgen_button = Button(right_frame, text="Générer un mot de passe", font=("Montserrat, 15"), bg='white', fg="#2D2D2D", command=generate_password)
pasgen_button.pack(pady=10, fill=X)
