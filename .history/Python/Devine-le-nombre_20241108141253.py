...
reponse = 0
while reponse != nombre_secret and nbr_essaies > nbr_essaies_max:
    reponse = int(input("Choisi un nombre : "))
    print("Essaie n°", nbr_essaies)
    if reponse < nombre_secret and reponse != nombre_secret:
        print("Plus haut")
    elif reponse > nombre_secret and reponse != nombre_secret:
        print("Plus bas")
    else:
