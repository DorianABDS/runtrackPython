...
my_text = customtkinter.CTkTextbox(window, width=600, height=300)
my_text.pack(pady=20)

my_button = customtkinter.CTkButton(window, text="Change Light/Dark", command=change)
my_button.pack(pady=20)

colors = ["blue", "dark-blue", "green"]
my_option = customtkinter.CTkOptionMenu(window, values=colors, command=change_colors)
